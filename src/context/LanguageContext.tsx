...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.trustee.3': 'G Vadiraj Kamarur - Secretary',
    ...
    // Seva List
    'seva.sarva_samarpana': 'Sarva Samarpana Seva',
    'seva.kanaka_mahapooja': 'Kanaka Mahapooja',
    'seva.rajatha_rathotsava': 'Rajatha Rathotsava',
    'seva.suvarna_paduka': 'Suvarna Paduka Offering',
    'seva.mahapooja': 'Mahapooja',
    'seva.suvarna_kavacha': 'Suvarna Kavacha Seva',
    'seva.kanakabhisheka': 'Kanakabhisheka',
    'seva.sarva_seva': 'Sarva Seva',
    'seva.rajatha_kavacha': 'Rajatha Kavacha Seva',
    'seva.ghee_nandadeepa': 'Ghee Nandadeepa (Monthly)',
    'seva.oil_nandadeepa': 'Oil Nandadeepa (Monthly)',
    'seva.brindavana_alankara': 'Brindavana Alankara',
    'seva.tulabhara': 'Tulabhara (Excluding items)',
    'seva.panchamruta': 'Panchamruta',
    'seva.hasthodaka': 'Hasthodaka',
    'seva.padapooja': 'Padapooja',
    'seva.pallakki_utsava': 'Pallakki Utsava (Thursdays only)',
    'seva.ksheerabhisheka': 'Ksheerabhisheka',
    'seva.archane': 'Archane',
    ...
    'contact.tabs.message': 'Message',
    'contact.tabs.feedback': 'Feedback',
    'contact.form.title': 'Send us a Message',
    'contact.form.name': 'Full Name',
    'contact.form.name.placeholder': 'Please enter your full name',
    'contact.form.email': 'Email Address',
    'contact.form.email.placeholder': 'e.g., devotee@example.com',
    'contact.form.subject': 'Subject',
    'contact.form.subject.placeholder': 'What is this regarding?',
    'contact.form.message': 'Your Message',
    'contact.form.message.placeholder': 'Type your message or inquiry here...',
    ...
    'feedback.form.name.placeholder': 'Your Name',
    'feedback.form.location': 'Location',
    'feedback.form.location.placeholder': 'Your City or Town',
    'feedback.form.comments': 'Comments',
    'feedback.form.comments.placeholder': 'Tell us about your visit and experience...',
    'feedback.form.submit': 'Submit Feedback',
    'feedback.note': 'Your feedback helps us improve our services and the maintenance of the Mutt.',
    'feedback.success': 'Thank you for your feedback! It helps us serve you better.',
  ...
  kn: {
    ...
    'about.p1': 'ತುಂಗಾ ಮತ್ತು ಭದ್ರಾ ನದಿಗಳು ಸಂಗಮವಾದ ಬಳಿಕ ಸಿಗುವ ಪುಣ್ಯ ಕ್ಷೇತ್ರವೇ ಹೊನ್ನಾಳಿ. ಶ್ರೀ ರಾಘವೇಂದ್ರ ಸ್ವಾಮಿಗಳು ಮಂತ್ರಾಲಯದಲ್ಲಿ ಬೃಂದಾವನ ಪ್ರವೇಶಿಸಿದ ಕೇವಲ 2 ವರ್ಷದಲ್ಲಿ ಹೊನ್ನಾಳಿಯಲ್ಲಿ ಸ್ವತಃ ರಾಯರೇ ಬಂದು ಇಲ್ಲಿ ನೆಲೆಸಿದ್ದಾರೆಂಬುದೇ ವಿಶೇಷ. ಹೀಗಾಗಿ ಹೊನ್ನಾಳಿ ದ್ವಿತೀಯ ಮಂತ್ರಾಲಯ ಎಂದೇ ಖ್ಯಾತಿಯಾಗಿದೆ. ಪ್ರತಿ ವರ್ಷ ಸಾವಿರಾರು ಭಕ್ತರು ಶ್ರೀಮಠಕ್ಕೆ ಆಗಮಿಸಿ ರಾಯರ ಅನುಗ್ರಹಕ್ಕೆ ಪಾತ್ರರಾಗಿದ್ದಾರೆ.',
    ...
    'about.history.desc2': 'ಹೊನ್ನಾಳಿಯ ಅಗ್ರಹಾರದಲ್ಲಿದ್ದ ರಾಮಾಚಾರ್ಯರಿಗೆ ಸ್ವಪ್ನದಲ್ಲಿ ರಾಯರು ಬಂದು ತಮ್ಮ ಮೃತ್ತಿಕಾ ಬೃಂದಾವನವನ್ನು ಪ್ರತಿಷ್ಠಾಪಿಸುವಂತೆ ಸೂಚಿಸಿದರು. ಆ ಸ್ವಪ್ನ ಸೂಚನೆಯನ್ನು ಊರಿನ ಪ್ರಮುಖರೆದುರು ಆಚಾರ್ಯರು ವಿಜ್ಞಾಪಿಸಿದಾಗ ಊರಿನ ಜನರೂ ಒಪ್ಪಿಗೆ ಸೂಚಿಸಿದರು. ಬೃಂದಾವನ ಪ್ರತಿಷ್ಠಾಪನೆ ಮಾಡಲು ಬೇಕಾದ ಅಗತ್ಯ ಸಿದ್ಧತೆಗಳು ನಡೆದವು. ಅದರಂತೆ ಮೃತ್ತಿಕಾ ತರಲು ಹೊನ್ನಾಳಿಯಿಂದ ಮಂತ್ರಾಲಯಕ್ಕೆ ತಂಡವೊಂದು ಹೊರಟಿತು. ಆದರೆ ಪ್ರತಿಷ್ಠಾಪನಾ ಮುಹೂರ್ತದ ದಿನ (ಫาಲ್ಗುಣ ಬಹುಳ ತೃತೀಯ) ಬಂದರೂ ಮಂತ್ರಾಲಯಕ್ಕೆ ಮೃತ್ತಿಕಾ ತರಲು ಹೋಗಿದ್ದವರು ಬರಲೇ ಇಲ್ಲ. ಇದೇ ವಿಚಾರ ಮಾತನಾಡುತ್ತಾ ತುಂಗಭದ್ರಾ ನದಿಯಲ್ಲಿ ಸ್ನಾನ ಮಾಡುವ ವೇಳೆ ರಾಮಾಚಾರ್ಯರು ಪ್ರಸ್ತಾಪಿಸುತ್ತಾ ಆತಂಕಿತರಾಗಿದ್ದರು. ಈ ವೇಳೆ ನದಿಯಲ್ಲೇ ಸ್ನಾನ ಮಾಡುತ್ತಿದ್ದ ತೇಜೋಮಯರಾದ( ಬ್ರಾಹ್ಮಣ) ವ್ಯಕ್ತಿಯೊಬ್ಬರು “ನಾನು ಮಂತ್ರಾಲಯದಿಂದಲೇ ಬಂದಿದ್ದೇನೆ. ನನ್ನ ಬಳಿ ರಾಯರ ಮೃತ್ತಿಕಾ ಇದೆ!”. ನಾನು ಮುಹೂರ್ತ ನೆರವೇರಿಸಲೇ? ಎಂದು ಕೇಳುತ್ತಾರೆ. ಈ ಘಟನೆ ಅಲ್ಲಿದ್ದವರಿಗೆ ತೀರಾ ಆಶ್ಚರ್ಯವೆನಿಸಿದರೂ ಬೃಂದಾವನ ಪ್ರತಿಷ್ಠಾಪನಾ ಮುಹೂರ್ತ ಮೀರಬಾರದೆಂಬ ಕಾರಣಕ್ಕೆ ದೇವರ ಸಂಕಲ್ಪವೇ ಇದಾಗಿರಬೇಕೆಂದು ಭಾವಿಸಿ ಸಮ್ಮತಿಸುತ್ತಾರೆ. ಮೃತ್ತಿಕಾ ಇದೆ ಎಂದ ಬ್ರಾಹ್ಮಣ ತಾನು ಗರ್ಭಗುಡಿಯ ಒಳಗೆ ಹೋಗಿ ಬಾಗಿಲು ಹಾಕಿಕೊಳ್ಳುತ್ತಾರೆ. ಎಷ್ಟೇ ಸಮಯ ಕಳೆದರೂ ಹೊರಗೆ ಬರುವುದೇ ಇಲ್ಲ..! ಕೊನೆಗೆ ಊರಿನ ಪ್ರಮುಖರೆಲ್ಲರೂ ಸೇರಿ ಗರ್ಭಗುಡಿಯ ಬಾಗಿಲು ತೆಗೆದು ನೋಡಲು ನಿರ್ಧರಿಸುತ್ತಾರೆ. ನೋಡಿದರೆ ಒಳಗೆಮುಹೂರ್ತ ನೆರವೇರಿಸುತ್ತೇನೆಂದು ತೆರಳಿದ ಆ ಬ್ರಾಹ್ಮಣ ಅದೃಶ್ಯರಾಗಿರುತ್ತಾರೆ! ಬೃಂದಾವನದ ಮೇಲೆ ಒಂದು ತಾಮ್ರದ ಹರಿವಾಣದಲ್ಲಿ ನರಸಿಂಹ ಸಾಲಿಗ್ರಾಮ, ಪ್ರಾಣದೇವರ ವಿಗ್ರಹ ಮತ್ತು ಹಳದಿ ಮಂತ್ರಾಕ್ಷತೆ ಇರುತ್ತದೆ. ಈ ಘಟನೆಯಿಂದ ಚಕಿತರಾದ ಊರಿನ ಜನತೆ ಸಾಕ್ಷಾತ್ ರಾಘವೇಂದ್ರ ಸ್ವಾಮಿಗಳೇ ಇಲ್ಲಿಗೆ ಬಂದು ಸ್ವತಃ ಬೃಂದಾವದಲ್ಲಿ ಸನ್ನಿಹಿತರಾಗಿದ್ದಾರೆ ಎಂದು ಆನಂದಗೊಳ್ಳುತ್ತಾರೆ. ಅಂದಿನಿಂದ ಈ ಕ್ಷೇತ್ರ ದ್ವಿತೀಯ ಮಂತ್ರಾಲಯವಾಗುತ್ತದೆ.',
    ...
    'about.miracle.2': 'ಬ್ರಿಟಿಷ್ ಸರ್ಕಾರದ ಅಧಿಕಾರಿ ಮತ್ತು ಕಂಟ್ರಾಕ್ಟರ್ ಇಬ್ಬರಿಗೂ ಸ್ವಪ್ನ ಸೂಚನೆಯ ಮೂಲಕವೇ ಹೊನ್ನಾಳಿಯ ಮಠದ ಪ್ರಕಾರದ ನಿರ್ಮಾಣವಾಗಿದೆ. ಈ ಮಾಹಿತಿಯನ್ನು ನ್ಯಾಯಾಧೀಶರೊಬ್ಬರು ದಾಖಲು ಮಾಡಿದ್ದಾರೆ.',
    'about.miracle.3': 'ಈಗಲೂ ಸಹ ಪ್ರಾತಃ ಕಾಲ ಬ್ರಾಹ್ಮೀ ಮುಹೂರ್ತದಲ್ಲಿ ರಾಯರು ನದಿ ಸ್ನಾನಕ್ಕೆ ತೆರಳುತ್ತಾರೆ. ಅನೇಕ ಮಂದಿಗೆ ದರ್ಶನವಾಗಿದೆ. ಕೆಲವರಿಗೆ ಆವುಗೆಯ(ಮರದ ಪಾದುಕೆ) ಶಬ್ದ ಕೇಳಿಸಿದೆ. ಈ ಅನುಭವ ಹಂಚಿಕೊಂಡಿದ್ದಾರೆ.',
    ...
    'about.trustees.desc': 'ಶ್ರೀ ರಾಘವೇಂದ್ರ ಸೇವಾ ಟ್ರಸ್ಟ್(ರಿ.) ಶ್ರೀಮಠದ ಆಡಳಿತ ನಿರ್ವಹಣೆಯನ್ನು ಮಾಡುತ್ತಿದೆ. ಶ್ರೀಮಠವನ್ನು ಧಾರ್ಮಿಕ ಮತ್ತು ಸಾಮಾಜಿಕ ಕೇಂದ್ರ ಮಾಡುವಲ್ಲಿ ಟ್ರಸ್ಟ್ ಯಶಸ್ವಿಯಾಗಿದೆ. ಮಠಕ್ಕೆ ಆಗಮಿಸುವ ಭಕ್ತರಿಗೆ ಗೌರವಾದರಗಳೊಂದಿಗೆ ಸ್ವಾಗತಿಸುತ್ತದೆ. ಸದಸ್ಯರ ಮಾಹಿತಿ ಇಂತಿದೆ.',
    'about.trustee.1': 'ಹೆಚ್.ಎಂ. ಶ್ರೀನಿವಾಸಮೂರ್ತಿ ಅಧ್ಯಕ್ಷರು',
    'about.trustee.2': 'ಕೆ.ಆರ್. ಶ್ರೀನಿವಾಸ್ ಉಪಾಧ್ಯಕ್ಷರು',
    'about.trustee.3': 'ಜಿ. ವಾದಿರಾಜ್ ಕಮರೂರ್ ಕಾರ್ಯದರ್ಶಿ',
    ...
    'act.goshala.desc': 'ನಮ್ಮ ಗೋಶಾಲೆಯು 50 ಕ್ಕೂ ಹೆಚ್ಚು ಸ್ಥಳೀಯ ಹಸುಗಳಿಗೆ ನೆಲೆಯಾಗಿದೆ. ಕಾಮಧೇನು ಗೋಶಾಲೆಯಲ್ಲಿ ಅವುಗಳಿಗೆ ಪೌಷ್ಟಿಕ ಮೇವು, ಶುದ್ಧ ನೀರು ಮತ್ತು ವೈದ್ಯಕೀಯ ಆರೈಕೆಯನ್ನು ಒದಗಿಸುತ್ತೇವೆ. ಗೋದಾನ ಸೇವೆಯನ್ನು ನಮ್ಮ ಭಾರತೀಯ ಸಂಪ್ರದಾಯದಲ್ಲಿ ಅತ್ಯಂತ ಪುಣ್ಯದ ಕಾರ್ಯಗಳಲ್ಲಿ ಒಂದೆಂದು ಪರಿಗಣಿಸಲಾಗಿದೆ.',
    ...
    // Seva List
    'seva.sarva_samarpana': 'ಸರ್ವಸಮರ್ಪಣಾ ಸೇವಾ',
    'seva.kanaka_mahapooja': 'ಕನಕಮಹಾಪೂಜೆ',
    'seva.rajatha_rathotsava': 'ರಜತ ರಥೋತ್ಸವ',
    'seva.suvarna_paduka': 'ಸುವರ್ಣ ಪಾದುಕಾ ಸಮರ್ಪಣೆ',
    'seva.mahapooja': 'ಮಹಾಪೂಜೆ',
    'seva.suvarna_kavacha': 'ಸುವರ್ಣ ಕವಚ ಸೇವಾ',
    'seva.kanakabhisheka': 'ಕನಕಾಭಿಷೇಕ',
    'seva.sarva_seva': 'ಸರ್ವಸೇವಾ',
    'seva.rajatha_kavacha': 'ರಜತ ಕವಚ ಸೇವಾ',
    'seva.ghee_nandadeepa': 'ತುಪ್ಪದ ನಂದಾದೀಪ (ಒಂದು ತಿಂಗಳಿಗೆ)',
    'seva.oil_nandadeepa': 'ತೈಲದ ನಂದಾದೀಪ (ಒಂದು ತಿಂಗಳಿಗೆ)',
    'seva.brindavana_alankara': 'ಬೃಂದಾವನ ಅಲಂಕಾರ',
    'seva.tulabhara': 'ತುಲಾಭಾರ (ಪದಾರ್ಥದ ಹೊರತು)',
    'seva.panchamruta': 'ಪಂಚಾಮೃತ',
    'seva.hasthodaka': 'ಹಸ್ತೋದಕ',
    'seva.padapooja': 'ಪಾದಪೂಜೆ',
    'seva.pallakki_utsava': 'ಪಲ್ಲಕ್ಕಿ ಉತ್ಸವ (ಗುರುವಾರ ಮಾತ್ರ)',
    'seva.ksheerabhisheka': 'ಕ್ಷೀರಾಭಿಷೇಕ',
    'seva.archane': 'ಅರ್ಚನೆ',
    ...
    'contact.tabs.message': 'ಸಂದೇಶ',
    'contact.tabs.feedback': 'ಪ್ರತಿಕ್ರಿಯೆ',
    'contact.form.title': 'ನಮಗೆ ಸಂದೇಶ ಕಳುಹಿಸಿ',
    'contact.form.name': 'ಪೂರ್ಣ ಹೆಸರು',
    'contact.form.name.placeholder': 'ದಯವಿಟ್ಟು ನಿಮ್ಮ ಪೂರ್ಣ ಹೆಸರನ್ನು ನಮೂದಿಸಿ',
    'contact.form.email': 'ಇಮೇಲ್ ವಿಳಾಸ',
    'contact.form.email.placeholder': 'ಉದಾಹರಣೆ: devotee@example.com',
    'contact.form.subject': 'ವಿಷಯ',
    'contact.form.subject.placeholder': 'ಇದು ಯಾವುದರ ಬಗ್ಗೆ?',
    'contact.form.message': 'ನಿಮ್ಮ ಸಂದೇಶ',
    'contact.form.message.placeholder': 'ನಿಮ್ಮ ಸಂದೇಶ ಅಥವಾ ವಿಚಾರಣೆಯನ್ನು ಇಲ್ಲಿ ಬರೆಯಿರಿ...',
    'contact.form.submit': 'ಸಂದೇಶ ಕಳುಹಿಸಿ',
    'contact.success': 'ನಿಮ್ಮ ಸಂದೇಶವನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಕಳುಹಿಸಲಾಗಿದೆ! ನಾವು ಶೀಘ್ರದಲ್ಲೇ ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸುತ್ತೇವೆ.',
    
    'feedback.title': 'ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆ ನಮಗೆ ಅಮೂಲ್ಯ',
    'feedback.rate': 'ನಿಮ್ಮ ಅನುಭವವನ್ನು ರೇಟ್ ಮಾಡಿ',
    'feedback.form.name': 'ಪೂರ್ಣ ಹೆಸರು',
    'feedback.form.name.placeholder': 'ನಿಮ್ಮ ಹೆಸರು',
    'feedback.form.location': 'ಸ್ಥಳ',
    'feedback.form.location.placeholder': 'ನಗರ ಅಥವಾ ಊರು',
    'feedback.form.comments': 'ಕಾಮೆಂಟ್‌ಗಳು',
    'feedback.form.comments.placeholder': 'ನಿಮ್ಮ ಭೇಟಿಯ ಅನುಭವದ ಬಗ್ಗೆ ನಮಗೆ ತಿಳಿಸಿ...',
    'feedback.form.submit': 'ಪ್ರತಿಕ್ರಿಯೆ ಸಲ್ಲಿಸಿ',
    'feedback.note': 'ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆಯು ನಮ್ಮ ಸೇವೆಗಳನ್ನು ಮತ್ತು ಮಠದ ನಿರ್ವಹಣೆಯನ್ನು ಸುಧಾರಿಸಲು ನಮಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ.',
    'feedback.success': 'ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆಗಾಗಿ ಧನ್ಯವಾದಗಳು! ಇದು ನಿಮಗೆ ಉತ್ತಮವಾಗಿ ಸೇವೆ ಸಲ್ಲಿಸಲು ನಮಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ.',
