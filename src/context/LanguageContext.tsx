...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.trustee.3': 'Sudheendra Mathada - Joint Secretary',
    'about.trustee.4': 'H.S. Raghavendra - Treasurer',
    'about.trustee.5': 'N. Jayarao - Director',
    'about.trustee.6': 'C. Satyanarayanarao - Director',
    'about.trustee.7': 'M.V. Badari Narayana - Director',
    'about.trustee.8': 'H.N. Gurudatta - Director',
    'about.trustee.9': 'Rajeeva Raghavendra - Director',
    'about.trustee.10': 'S.N. Prakasha - Director',
  ...
  kn: {
    ...
    'about.trustee.3': 'ಸುಧೀಂದ್ರ ಮಠದ ಸಹ-ಕಾರ್ಯದರ್ಶಿ',
    'about.trustee.4': 'ಹೆಚ್.ಎಸ್. ರಾಘವೇಂದ್ರ ಖಜಾಂಚಿ',
    'about.trustee.5': 'ಎನ್. ಜಯರಾವ್ ನಿರ್ದೇಶಕರು',
    'about.trustee.6': 'ಸಿ. ಸತ್ಯನಾರಾಯಣರಾವ್ ನಿರ್ದೇಶಕರು',
    'about.trustee.7': 'ಎಂ.ವಿ. ಬದರೀ ನಾರಾಯಣ ನಿರ್ದೇಶಕರು',
    'about.trustee.8': 'ಹೆಚ್.ಎನ್. ಗುರುದತ್ತ ನಿರ್ದೇಶಕರು',
    'about.trustee.9': 'ರಾಜೀವ ರಾಘವೇಂದ್ರ ನಿರ್ದೇಶಕರು',
    'about.trustee.10': 'ಎಸ್.ಎನ್. ಪ್ರಕಾಶ ನಿರ್ದೇಶಕರು',
