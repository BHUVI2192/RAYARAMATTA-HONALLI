...
import { Heart, Info, BookOpen, Globe, CreditCard, User, Phone, Mail, IndianRupee, CheckCircle, Loader2, X, Droplets } from 'lucide-react';
                    ...
                    <AnimatePresence mode="wait">
                      {showSuccess ? (
                        ...
                        >
                          ...
                          <h2 className="text-2xl font-bold text-[#8B0000] mb-2">Payment Successful ≡ƒÄë</h2>
                          ...
                          <div className="bg-emerald-50 rounded-2xl p-6 border border-emerald-100 mb-8 text-left">
                            <div className="flex justify-between items-center pb-4 border-b border-emerald-200">
                              ...
                              <span className="text-[#8B0000] font-bold text-lg">Γé╣{successAmount}</span>
                            </div>
                            <div className="pt-4">
